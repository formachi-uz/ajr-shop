...
async def ensure_runtime_schema(conn):
    ...
    statements = [
        ...
        "ALTER TABLE orders ADD COLUMN IF NOT EXISTS order_channel_chat_id BIGINT",
        "ALTER TABLE orders ADD COLUMN IF NOT EXISTS order_channel_message_id INTEGER",
        "ALTER TABLE orders ADD COLUMN IF NOT EXISTS order_channel_has_media BOOLEAN DEFAULT FALSE",
